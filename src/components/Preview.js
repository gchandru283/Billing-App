...
function Preview({ jsonData }) {
  ...
  return (
    <div className="h-fit w-full max-w-md py-10 font-sans bg-yellow-100">
      <h1 className="font-bold text-xl text-center">George's Cafe</h1>
      ...
      <div className="text-right text-md font-semibold p-2 pt-3 pb-10">
        TOTAL PRICE:
        <span className="text-right text-md tracking-wide pl-3 ">
          Rs. {jsonData.Total.Total}
        </span>
      </div>
